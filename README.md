...
有了shadowsocks账号后，接下来怎么用？剩下的只需要下载安装Shadowsocks客户端（***注意：是Shadowsocks客户端，简称SS客户端，不是SSR客户端，Just My Socks不支持SSR，请使用下面官方网站的下载链接下载客户端***）并导入购买的服务器即可使用啦，其中有1个或2个服务器因为需要使用插件，所以不提供分享二维码和分享连接，需要手工将服务器参数输入客户端。
